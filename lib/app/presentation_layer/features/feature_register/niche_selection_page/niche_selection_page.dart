...
class NicheSelectionPage extends StatefulWidget {
  final ServiceLocator serviceLocator;
  const NicheSelectionPage(this.serviceLocator, {super.key});

  @override
  State<NicheSelectionPage> createState() => _NicheSelectionPageState();
}

class _NicheSelectionPageState extends State<NicheSelectionPage> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            CustomAppBarMain(title: "Choose Your Top", extratitle: "10 Niches"),
        ...
        child: Container(
          ...
          child: CustomRoundedButton(
            ...
            onpress: () {
              Navigator.of(
                context,
              ).push(CustomRoute(builder: (context) => BrandPartnershipPage(widget.serviceLocator)));
            },
          ),
        ),
      ),
